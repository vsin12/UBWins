...
for position in directory:
    ...
    if best_init_beam == (-1,-1):
        ...
        print "best_init_beam_text : ",best_init_beam_text
        print "best_init_mcs : ",best_init_mcs
...
for pos in positions:
    #print pos
    #print beam_tput_overall[pos]
    print convert_beam_to_text(best_beam_dict[pos]) + '_[' + best_init_mcs + ']'
...
for pos in positions:
    max_tput = -1
    #print beam_tput_overall[pos][best_init_beam_text + '_[6]']
...
for rect, label in zip(rects, label):
    ...
    ax.text(rect.get_x() + rect.get_width() / 2, 0, label,
            ha='center', va='bottom', fontsize = '4', rotation = 'vertical',color = 'red')
